...
namespace HoleNexusLauncher.API
{
    public static class HaQuynhAnh
    {
        ...
        {
            return KickRegex.Replace(source, "print('[HoleNexus Protection] Kick function blocked.')");
        }
        ...
        {
            if (string.IsNullOrEmpty(title)) title = "HoleNexus";
            if (string.IsNullOrEmpty(text)) text = "Injected Successfully!";
            if (string.IsNullOrEmpty(idIcon)) idIcon = "16863343922";
        ...
        {
            if (string.IsNullOrEmpty(Name)) Name = "HoleNexus/HaQuynhAnh/AlexHerrySeek 🥀💕";
        ...
        {
            if (string.IsNullOrEmpty(Name)) Name = "HoleNexus";
            if (string.IsNullOrEmpty(Version)) Version = "v0.0.4";
        ...
        {
            nint ptr = GetClients();
            if (ptr == nint.Zero) return new List<ClientInfo>();
